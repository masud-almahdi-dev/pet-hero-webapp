...
const Navbar = () => {
    ...
    return (
        <div className="w-full bg-slate-700 h-44 lg:h-min flex sticky top-0 p-4 text-center justify-between box-border lg:items-center items-start flex-wrap z-20">
